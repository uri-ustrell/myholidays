...
<div class="ownProfileDisplay col">
	<form method="POST" id="userRegisterForm" class="userProfileForm  p-4  mx-auto  border  border-secundary  bg-light  rounded" action="{{ route('profile.update') }}">
		<div class="form-group">
			...
			<input type="text" id="myLib_reg_user" class="form-control  form-control-lg" aria-describedby="userHelpBlock" placeholder="your name" value="{{ $name }}" required>
		...
		<div class="form-group">
			...
			<input type="email" id="myLib_reg_email" class="form-control  form-control-lg" aria-describedby="emailHelpBlock" placeholder="happyUser@mail.com" value="{{ $email }}" required>
		...
		<div class="form-group">
			...
			<input type="text" id="myLib_reg_dptm" class="form-control  form-control-lg" placeholder="your department" aria-describedby="dptmHelpBlock" value="{{ $department }}" required>
		...
		<div class="form-group">
			...
			<input type="date" id="myLib_reg_hired" class="form-control  form-control-lg" placeholder="10/05/2015" aria-describedby="hiredHelpBlock" value="{{ $hired }}" required disabled>
		...
		<div class="form-group">
			...
			<input type="number" id="myLib_reg_vacations" class="form-control  form-control-lg" placeholder="23" aria-describedby="vacationsHelpBlock" value="{{ $vacations }}" required disabled>
