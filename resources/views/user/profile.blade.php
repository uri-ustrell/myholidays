...
<form method="POST" id="userRegisterForm" class="userProfileFormp-4  mx-auto  border  border-secundary  bg-light  rounded">
...
<div class="alert alert-danger" role="alert">
  <i>We'll fill up these with <b>Angular</b></i>
</div>
@endsection